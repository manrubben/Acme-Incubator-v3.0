...
@Service
public class AdministratorOverturesDeleteService implements AbstractDeleteService<Administrator, Overtures> {
	...
	@Override
	public void delete(final Request<Overtures> request, final Overtures entity) {
		assert request != null;
		assert entity != null;
